...
import { LayoutDashboard, Activity, History, Brain, Bell, Settings2, Info, Gauge } from "lucide-react";
...
export default function Sidebar() {
  return (
    <aside className="w-60 shrink-0 bg-base-900 border-r border-base-800 flex flex-col">
